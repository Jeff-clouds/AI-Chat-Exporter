...
> **AI 文档提示**：本项目的说明性文档由 AI 撰写，可能不正确。执行前必须以当前代码、有效项目规则、真实运行态及必要的官方来源复核。
...
1. When the maintainer private workspace is linked, read `private-docs/architecture/PLATFORM_ARCHITECTURE_GUIDE.md` first. Otherwise, use the current code and public repository rules as the available baseline.
...
9. Update the drift ledger and evidence date in `private-docs/architecture/PLATFORM_ARCHITECTURE_GUIDE.md` when the private workspace mapping is available.
