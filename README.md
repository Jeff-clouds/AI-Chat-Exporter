...
**AI Chat Export Pro** 是一款面向 AI 长对话整理的浏览器扩展。当前对外版本为 **v2.0.5**，是原 **AI Chat Outline** 的迭代合并版：保留侧边栏大纲导航能力，合并完整 Markdown 导出能力，并新增 Pro 局部导出。
...
1. 克隆本项目到本地：
   ```bash
   git clone https://github.com/Jeff-clouds/AI-Chat-Export-Pro.git
   ```
